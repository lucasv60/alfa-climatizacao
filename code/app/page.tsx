            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Precisa de ar condicionado novo ou manutenção? Fale Agora no WhatsApp e solicite um orçamento sem compromisso!
                </p>
              </div>
              <div className="relative h-[400px] lg:h-[500px]">
                <img
                  src="/industrial-refrigeration-system-with-pipes-and-equ.jpg"
                  alt="Sistema de ar condicionado profissional"
        ...
        <section className="py-16 md:py-24 bg-muted/30">
          <div className="container mx-auto px-4">
              ...
              <Card className="border-2 hover:border-primary transition-colors">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <h3 className="font-semibold text-lg">Instalação Segura</h3>
              ...
              <Card className="border-2 hover:border-primary transition-colors">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <h3 className="font-semibold text-lg">Atendimento Rápido</h3>
                    <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              <Card className="border-2 hover:border-primary transition-colors">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <h3 className="font-semibold text-lg">Técnicos Certificados</h3>
                    <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <div className="text-center mt-8">
              <p className="text-sm text-muted-foreground">
                Problemas com ar condicionado? Fale Agora no WhatsApp e receba atendimento imediato!
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                <Badge variant="outline" className="w-fit">
                  PMOC - Manutenção de Ar Condicionado
                </Badge>
                <h2 className="text-3xl md:text-4xl font-bold text-balance">
                  Plano de Manutenção para Ar Condicionado
                </h2>
                ...
                <p className="text-sm text-muted-foreground">
                  Precisa de manutenção para seu ar condicionado? Fale Agora no WhatsApp e solicite um orçamento sem compromisso!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-8">
              ...
              <p className="text-sm text-muted-foreground mt-4">
                Precisa de orçamento para ar condicionado? Fale Agora no WhatsApp e solicite um orçamento sem compromisso!
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              ...
              <p className="text-sm text-primary-foreground/80">
                Instalação, manutenção ou reparo de ar condicionado? Fale Agora no WhatsApp e solicite um orçamento sem compromisso!
              </p>
            </div>
          </div>
        </section>
